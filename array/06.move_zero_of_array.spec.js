const { moveAllZeroOfArrayOptimized } = require("./06.move_zero_of_array");
...
describe("unit tests for moveAllZeroOfArray function", () => {
  ...
  it("moveAllZeroOfArray with case #5", () => {
    const result = moveAllZeroOfArrayOptimized([1, 2, 3, 4, 5]);
    expect(result).toEqual([1, 2, 3, 4, 5]);
  });

  test("moveAllZeroOfArray with case #6", () => {
    const result = moveAllZeroOfArrayOptimized([2]);
